...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2024 at 11:15 AM
...
INSERT INTO `books` (`book_id`, `title`, `author`, `status`, `cover_image`, `price`, `genre`, `availability`) VALUES
(1, 'gertt', 'ertt', 'available', 'uploads/Duckky.png', 1000.00, '', 'available'),
(2, 'fr', 'ge', 'available', 'uploads/image.png', 1000000.00, '', 'available');
...
(2, 1, 1, '2024-10-23 07:20:20', 'reserved');
...
(1, 'example_user', '', 'your_password_here');
...
--
ALTER TABLE `purchases`
  ADD CONSTRAINT `purchases_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `books` (`book_id`);
